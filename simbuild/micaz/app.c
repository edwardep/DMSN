...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f4af6e49cf8, const void *arg_0x7f4af6e48020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f4af6dc8618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f4af6b7f020), 
int (*key_eq_fn)(void *arg_0x7f4af6b7f798, void *arg_0x7f4af6b7fa38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f4af697b610, int arg_0x7f4af697b878);
static double RandomUniform(void );
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(265U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 377
  ...
  if (enqueueDone == SUCCESS) 
    {
      sim_log_debug(75U, "SRTreeC", "-RoutingRecE- receiveRoutingTask() posted!\n");
      SRTreeC__receiveRoutingTask__postTask();
    }
  else 
    {
      sim_log_debug(76U, "SRTreeC", "-RoutingRecE- Msg failed to be enqueued in RoutingReceiveQueue.");
    }
  return msg;
}
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(273U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 343
  ...
  if (enqueueDone == SUCCESS) 
    {
      sim_log_debug(72U, "SRTreeC", "-NotifyRecE- receiveNotifyTask() posted!\n");
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f4af6575908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f4af6575908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f4af6575908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f4af6574480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f4af6574480, msg, payload, len);
#line 78
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(78U, "SRTreeC", "-RoutingSendT- Queue is empty.\n");
      return;
    }
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(79U, "SRTreeC", "-RoutingSendT- RoutingRadio is Busy.\n");
  ...
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(80U, "SRTreeC", "-RoutingSendT- Unknown message. \n");
      return;
    }
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(81U, "SRTreeC", "-RoutingSendT- Send was successfull\n");
      SRTreeC__setRoutingSendBusy(TRUE);
    }
  else 
    {
      sim_log_debug(82U, "SRTreeC", "-RoutingSendT- Send failed!\n");
    }
}
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(271U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(272U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__sendNotifyTask__runTask(void )
{
  ...
  if (SRTreeC__NotifySendQueue__empty()) 
    {
      sim_log_debug(83U, "SRTreeC", "-NotifySendT- Queue is empty.\n");
      return;
    }
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(267U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(268U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  sim_log_debug(88U, "SRTreeC", "ReceiveRoutingTask(): len=%u \n", len);
  ...
  if (len == sizeof(RoutingMsg )) 
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
        {
          ...
          sim_log_debug(90U, "SRTreeC", "receiveRoutingTask():NotifyParentMsg sending to node= %d... \n", SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(91U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!");
          ...
          if (SRTreeC__curdepth[sim_node()] > __nesc_ntoh_uint8(mpkt->depth.nxdata) + 1 || __nesc_ntoh_uint16(mpkt->senderID.nxdata) == SRTreeC__parentID[sim_node()]) 
            {
              ...
              sim_log_debug(92U, "SRTreeC", "NotifyParentMsg sending to node= %d... \n", oldparentID);
    ...
    {
      sim_log_debug(96U, "SRTreeC", "receiveRoutingTask():Empty message!!! \n");
...
#line 82
{
  sim_log_debug(222U, "Serial", "Serial: sending a packet of size %d\n", len);
  return FAIL;
}

# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x7f4af5e20c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC__AMSend__send(arg_0x7f4af5e20c70, addr, msg, len);
#line 80
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(275U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(276U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__receiveNotifyTask__runTask(void )
{
  ...
  sim_log_debug(97U, "SRTreeC", "ReceiveNotifyTask(): len=%u \n", len);
  ...
  if (len == sizeof(NotifyParentMsg )) 
    {
      ...
      sim_log_debug(98U, "SRTreeC", "NotifyParentMsg received from %d !!! \n", __nesc_ntoh_uint16(mr->senderID.nxdata));
...
#line 667
              ...
              sim_log_debug(99U, "Serial", "Sending NotifyParentMsg to PC... \n");
...
#line 681
          ...
          sim_log_debug(100U, "SRTreeC", "Forwarding NotifyParentMsg from senderID= %d  to parentID=%d \n", __nesc_ntoh_uint16(m->senderID.nxdata), SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(101U, "SRTreeC", "receiveNotifyTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
              if (SRTreeC__NotifySendQueue__size() == 1) 
                {
                  SRTreeC__sendNotifyTask__postTask();
                }
    ...
    {
      sim_log_debug(102U, "SRTreeC", "receiveNotifyTask():Empty message!!! \n");
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f4af65766e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f4af65766e8, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f4af5e21990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f4af5e21990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f4af5e21990, msg, error);
#line 100
      break;
#line 100
    }
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x7f4af5e21990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f4af5e21990) {
#line 100
    case 0U:
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x7f4af5e21990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f4af6855108){
#line 75
  switch (arg_0x7f4af6855108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f4af6855108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f4af5e20c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f4af5e20c70, addr, msg, len);
#line 80
...
#line 237
  sim_log_debug(61U, "SRTreeC", "-RoutingSendE- RoutingMsgTimer fired!  RoutingRadio is %s \n", SRTreeC__RoutingSendBusy[sim_node()] ? "Busy" : "Free");
  ...
  if (SRTreeC__RoutingSendQueue__full()) 
    {
      sim_log_debug(63U, "SRTreeC", "-RoutingSendE- RoutingSendQueue is full.\n");
      return;
    }
  ...
  if (mrpkt == (void *)0) 
    {
      sim_log_debug(64U, "SRTreeC", "-RoutingSendE- No valid payload.\n");
      return;
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 263
...
#line 266
  ...
  sim_log_debug(65U, "SRTreeC", "-RoutingSendE- Broadcasting RoutingMsg\n");
  if (enqueueDone == SUCCESS) 
    {
      if (SRTreeC__RoutingSendQueue__size() == 1) 
        {
          sim_log_debug(66U, "SRTreeC", "-RoutingSendE- SendRoutingTask() posted!\n");
          SRTreeC__sendRoutingTask__postTask();
        }
    }
  else 
    {
      sim_log_debug(67U, "SRTreeC", "-RoutingSendE- Msg failed to be enqueued in RoutingSendQueue.");
    }
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f4af5ebfda0){
#line 83
  switch (arg_0x7f4af5ebfda0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f4af5ebfda0);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(250U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(249U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(246U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(247U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(239U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(229U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(235U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(236U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(241U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
static void SRTreeC__SerialAMSend__sendDone(message_t *msg, error_t err)
{
  if (&SRTreeC__serialPkt[sim_node()] == msg) 
    {
      sim_log_debug(70U, "Serial", "Serial Package sent %s \n", err == SUCCESS ? "True" : "False");
      SRTreeC__setSerialBusy(FALSE);
    }
}
...
static void SRTreeC__setSerialBusy(bool state)
{
  ...
  sim_log_debug(52U, "SRTreeC", "-F- SerialSendBusy = %s\n", state == TRUE ? "TRUE" : "FALSE");
}
...
static void SRTreeC__NotifyAMSend__sendDone(message_t *msg, error_t err)
{
  sim_log_debug(69U, "SRTreeC", "A Notify package sent... %s \n", err == SUCCESS ? "True" : "False");
  SRTreeC__setNotifySendBusy(FALSE);
...
#line 108
    __nesc_atomic_end(__nesc_atomic); }
#line 108
  sim_log_debug(51U, "SRTreeC", "-F- NotifySendBusy = %s\n", state == TRUE ? "TRUE" : "FALSE");
}
...
#line 102
    __nesc_atomic_end(__nesc_atomic); }
#line 102
  sim_log_debug(50U, "SRTreeC", "-F- RoutingSendBusy = %s\n", state == TRUE ? "TRUE" : "FALSE");
}
...
#line 285
  ...
  sim_log_debug(238U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(244U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(224U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(225U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(226U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(227U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(245U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(248U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(237U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(269U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 91
{
  ...
  sim_log_debug(251U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 2) {
      ...
      sim_log_debug(252U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(253U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 2;
      ...
      sim_log_debug(254U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
