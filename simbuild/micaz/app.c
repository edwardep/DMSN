...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f97ae223cf8, const void *arg_0x7f97ae222020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f97ae1a2618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f97adf59020), 
int (*key_eq_fn)(void *arg_0x7f97adf59798, void *arg_0x7f97adf59a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f97add55610, int arg_0x7f97add55878);
static double RandomUniform(void );
...
typedef TMilli SRTreeC__DelayTimer__precision_tag;
...
error_t error);
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__DelayTimer__fired(void );
...
# 73 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__DelayTimer__startOneShot(uint32_t dt);
# 104 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/SplitControl.nc"
...
uint16_t SRTreeC__check_sum[1000];
#line 77
...
#line 241
static inline void SRTreeC__DelayTimer__fired(void );
...
#line 337
static inline void SRTreeC__NotifyAMSend__sendDone(message_t *msg, error_t err);
...
enum SerialActiveMessageC____nesc_unnamed4340 {
#line 67
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0____nesc_unnamed4342 {
...
message_t * amsg);
# 126 "/home/tinyos/local/src/tinyos-2x/tos/system/AMQueueImplP.nc"
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4350 {
#line 126
...
#line 57
#line 55
typedef struct /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4352 {
  message_t * msg;
...
#line 403
      ...
      if (enqueueDone == SUCCESS) 
        ...
        {
          sim_log_debug(74U, "SRTreeC", "-RoutingRecE- Msg failed to be enqueued in RoutingReceiveQueue.");
        }
    }
...
static inline message_t *SRTreeC__NotifyReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(71U, "SRTreeC", "-NotifyRecE- check_sum: %u, Source: %u \n", __nesc_ntoh_uint16(((NotifyParentMsg *)payload)->check_sum.nxdata), msource);
...
#line 372
  ...
  sim_log_debug(72U, "SRTreeC", "NotifyReceiveQueue Size: %d\n", SRTreeC__NotifyReceiveQueue__size());
  if (enqueueDone == SUCCESS) 
    {
    ...
    {
      sim_log_debug(73U, "SRTreeC", "-NotifyRecE- Msg failed to be enqueued in NotifyReceiveQueue.");
    }
  return msg;
}
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f97ad95f908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f97ad95f908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f97ad95f908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f97ad95e480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f97ad95e480, msg, payload, len);
#line 78
...
# 73 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void SRTreeC__DelayTimer__startOneShot(uint32_t dt){
#line 73
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(76U, "SRTreeC", "-RoutingSendT- Queue is empty.\n");
      return;
    }
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(77U, "SRTreeC", "_--------------------------------------------1\n");
      sim_log_debug(78U, "SRTreeC", "-RoutingSendT- RoutingRadio is Busy.\n");
  ...
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(79U, "SRTreeC", "-RoutingSendT- Unknown message. \n");
      return;
    }
  ...
  if (sendDone == SUCCESS) 
    ...
    {
      sim_log_debug(80U, "SRTreeC", "-RoutingSendT- Send failed!\n");
    }

  SRTreeC__DelayTimer__startOneShot(EPOCH_MILLI / (SRTreeC__curdepth[sim_node()] + 1));
  sim_log_debug(81U, "SRTreeC", "DelayTimer Started for NODE: %d, time: %d\n", TOS_NODE_ID, EPOCH_MILLI / (SRTreeC__curdepth[sim_node()] + 1));
}
...
static inline void SRTreeC__sendNotifyTask__runTask(void )
{
  ...
  if (SRTreeC__NotifySendQueue__empty()) 
    {
      sim_log_debug(82U, "SRTreeC", "-NotifySendT- Queue is empty.\n");
      return;
    }

  if (SRTreeC__NotifySendBusy[sim_node()] == TRUE) 
    {
      sim_log_debug(83U, "SRTreeC", "_-------------------------------------------2\n");
      sim_log_debug(84U, "SRTreeC", "-NotifySendT- NotifyRadio is Busy.\n");
  ...
  if (mlen != sizeof(NotifyParentMsg )) 
    {
      sim_log_debug(85U, "SRTreeC", "-NotifySendT- Unknown message.\n");
      return;
    }
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(86U, "SRTreeC", "-NotifySendT- Send was successfull.\n");
      SRTreeC__setNotifySendBusy(TRUE);
    }
  else 
    {
      sim_log_debug(87U, "SRTreeC", "-NotifySendT- Send failed.\n");
    }
}
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  if (len == sizeof(RoutingMsg )) 
    ...
    {
      sim_log_debug(88U, "SRTreeC", "_-------------------------------------------3\n");
      sim_log_debug(89U, "SRTreeC", "-RoutingRecT- Not a RoutingMsg.\n");
...
#line 611
      sim_log_debug(90U, "SRTreeC", "___________________________________________________\n");
      sim_log_debug(91U, "SRTreeC", "-NotifyRecT- Forwarding Msg from %d to %d\n", TOS_NODE_ID, SRTreeC__parentID[sim_node()]);
      sim_log_debug(92U, "SRTreeC", "old_sum: %d\n", SRTreeC__check_sum[sim_node()]);
      sim_log_debug(93U, "SRTreeC", "+%d \n", __nesc_ntoh_uint16(mr->check_sum.nxdata));
      SRTreeC__check_sum[sim_node()] = SRTreeC__check_sum[sim_node()] + __nesc_ntoh_uint16(mr->check_sum.nxdata);
      sim_log_debug(94U, "SRTreeC", "new_sum: %d\n", SRTreeC__check_sum[sim_node()]);
      sim_log_debug(95U, "SRTreeC", "___________________________________________________\n");
    }
  else 
#line 633
    {
      sim_log_debug(96U, "SRTreeC", "_--------------------------------------------4\n");
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      sim_log_debug(98U, "SRTreeC", "\n_____________________EPOCH___%u_______chksum=%d__________\n\n", SRTreeC__roundCounter[sim_node()], SRTreeC__check_sum[sim_node()]);
    }
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f97ad9616e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f97ad9616e8, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f97ad3aa990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f97ad3aa990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f97ad3aa990, msg, error);
#line 100
      break;
#line 100
    }
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x7f97ad3aa990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f97ad3aa990) {
#line 100
    case 0U:
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x7f97ad3aa990, msg, error);
#line 100
      break;
#line 100
    }
...
#line 82
{
  sim_log_debug(160U, "Serial", "Serial: sending a packet of size %d\n", len);
  return FAIL;
}

# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x7f97ad3a9c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC__AMSend__send(arg_0x7f97ad3a9c70, addr, msg, len);
#line 80
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f97adc2f108){
#line 75
  switch (arg_0x7f97adc2f108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f97adc2f108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f97ad3a9c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f97ad3a9c70, addr, msg, len);
#line 80
...
static inline void SRTreeC__RoutingMsgTimer__fired(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__full()) 
    {
      sim_log_debug(67U, "SRTreeC", "-TimerFiredE- RoutingSendQueue is full.\n");
      return;
    }
  ...
  if (mrpkt == (void *)0) 
    {
      sim_log_debug(68U, "SRTreeC", "-TimerFiredE- No valid payload.\n");
      return;
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 297
...
#line 300
  ...
  sim_log_debug(69U, "SRTreeC", "-TimerFiredE- Broadcasting RoutingMsg\n");
  if (enqueueDone == SUCCESS) 
    {
...
static inline void SRTreeC__LostTaskTimer__fired(void )
{
  sim_log_debug(61U, "SRTreeC", "_________________> LostTaskTimer fired! task: ");
  if (SRTreeC__lostRoutingSendTask[sim_node()]) 
    {
      sim_log_debug(62U, "SRTreeC", "sendRouting\n");
      SRTreeC__sendRoutingTask__postTask();
  ...
  if (SRTreeC__lostNotifySendTask[sim_node()]) 
    {
      sim_log_debug(63U, "SRTreeC", "sendNotify\n");
      SRTreeC__sendNotifyTask__postTask();
  ...
  if (SRTreeC__lostRoutingRecTask[sim_node()]) 
    {
      sim_log_debug(64U, "SRTreeC", "receiveRouting\n");
      SRTreeC__receiveRoutingTask__postTask();
  ...
  if (SRTreeC__lostNotifyRecTask[sim_node()]) 
    {
      sim_log_debug(65U, "SRTreeC", "receiveNotify\n");
      SRTreeC__receiveNotifyTask__postTask();
...
static inline void SRTreeC__EpochTimer__fired(void )
{
  ...
  __nesc_hton_uint16(m->check_sum.nxdata, SRTreeC__check_sum[sim_node()]);
  sim_log_debug(66U, "SRTreeC", "-EpochTimer.fired- Node: %d, check_sum: %d\n", TOS_NODE_ID, SRTreeC__check_sum[sim_node()]);
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f97ad452108){
#line 83
  switch (arg_0x7f97ad452108) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f97ad452108);
#line 83
      break;
#line 83
    }
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      SRTreeC__check_sum[sim_node()] = 1;
      sim_log_debug(53U, "Boot", "-BootE- curdepth = %d  ,  parentID= %d ,check_sum= %d\n", SRTreeC__curdepth[sim_node()], SRTreeC__parentID[sim_node()], SRTreeC__check_sum[sim_node()]);
    }
  else 
    {
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SRTreeC__check_sum"))
  {
    *addr = (uintptr_t)&SRTreeC__check_sum[__nesc_mote];
    *size = sizeof(SRTreeC__check_sum[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&SRTreeC__check_sum[__nesc_mote], 0, sizeof SRTreeC__check_sum[__nesc_mote]);
