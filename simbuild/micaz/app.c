...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7fa8cb07ccf8, const void *arg_0x7fa8cb07b020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7fa8caffb618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fa8cadb2020), 
int (*key_eq_fn)(void *arg_0x7fa8cadb2798, void *arg_0x7fa8cadb2a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fa8cabae610, int arg_0x7fa8cabae878);
static double RandomUniform(void );
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fa8ca7c0908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fa8ca7c0908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fa8ca7c0908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fa8ca7bf480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fa8ca7bf480, msg, payload, len);
#line 78
  ...
  if (len == sizeof(RoutingMsg )) 
    {
      ...
      SRTreeC__EpochTimer__startPeriodicAt(EPOCH_MILLI / (SRTreeC__curdepth[sim_node()] + 1) - TOS_NODE_ID * 100, EPOCH_MILLI);
...
#line 611
      ...
      sim_log_debug(91U, "SRTreeC", "old_sum: %d\n", SRTreeC__check_sum[sim_node()]);
      sim_log_debug(92U, "SRTreeC", "+%d \n", __nesc_ntoh_uint16(mr->check_sum.nxdata));
      SRTreeC__check_sum[sim_node()] = SRTreeC__check_sum[sim_node()] + __nesc_ntoh_uint16(mr->check_sum.nxdata);
      sim_log_debug(93U, "SRTreeC", "new_sum: %d\n", SRTreeC__check_sum[sim_node()]);
      sim_log_debug(94U, "SRTreeC", "___________________________________________________\n");
    }
  else 
#line 632
    {
      sim_log_debug(95U, "SRTreeC", "_--------------------------------------------4\n");
      sim_log_debug(96U, "SRTreeC", "-NotifyRecT- Not a NotifyMsg.\n");
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fa8ca7c16e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fa8ca7c16e8, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fa8ca211318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fa8ca211318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fa8ca211318, msg, error);
#line 100
      break;
#line 100
    }
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x7fa8ca211318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fa8ca211318) {
#line 100
    case 0U:
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x7fa8ca211318, msg, error);
#line 100
      break;
#line 100
    }
...
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x7fa8ca20f488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC__AMSend__send(arg_0x7fa8ca20f488, addr, msg, len);
#line 80
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fa8caa88108){
#line 75
  switch (arg_0x7fa8caa88108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fa8caa88108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fa8ca20f488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fa8ca20f488, addr, msg, len);
#line 80
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fa8ca2b3108){
#line 83
  switch (arg_0x7fa8ca2b3108) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fa8ca2b3108);
#line 83
      break;
#line 83
    }
